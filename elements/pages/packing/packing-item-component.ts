...
export class PackingItemComponent extends BaseComponent {
  readonly taskIdLabelLocator: Locator = this.componentLocator.locator('css=h3');
  readonly pickRequestDateLabelLocator: Locator = this.componentLocator.locator('css=p >> nth=1');
  readonly orderNoLabelLocator: Locator = this.componentLocator.locator('css=p >> nth=2');
